...
public class StoneMillMenu extends AbstractContainerMenu {
    ...
    public StoneMillMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public StoneMillMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.STONE_MILL_MENU.get(),id);
        checkContainerSize(inv, 2);
        blockEntity = (StoneMillBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.STONE_MILL.get());
    }
