...
public class ThreshingMachineScreen extends AbstractContainerScreen<ThreshingMachineMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation((Boulanger.MOD_ID), "textures/gui/threshing_machine.png");
    public ThreshingMachineScreen(ThreshingMachineMenu menu, Inventory inventory, Component component) {
