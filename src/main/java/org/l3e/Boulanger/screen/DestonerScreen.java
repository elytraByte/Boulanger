...
public class DestonerScreen extends AbstractContainerScreen<DestonerMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation((Boulanger.MOD_ID), "textures/gui/destoner.png");
    public DestonerScreen(DestonerMenu menu, Inventory inventory, Component component) {
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 77, y + 25, 176, 0, 20, menu.getScaledProgress());
