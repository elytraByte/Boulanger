...
public class AspiratorScreen extends AbstractContainerScreen<AspiratorMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation((Boulanger.MOD_ID), "textures/gui/threshing_machine.png");
    public AspiratorScreen(AspiratorMenu menu, Inventory inventory, Component component) {
