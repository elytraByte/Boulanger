...
public class StoneMillRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Type implements RecipeType<StoneMillRecipe> {
        ...
        public static final String ID = "stone_milling";
    }
    ...
    public static class Serializer implements RecipeSerializer<StoneMillRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Boulanger.MOD_ID, "stone_milling");

        @Override
        public StoneMillRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new StoneMillRecipe(pRecipeId, output, inputs);
        }

        @Override
        public @Nullable StoneMillRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new StoneMillRecipe(id, output, inputs);
        }
