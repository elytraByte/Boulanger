...
import net.boulangermod.boulanger.component.value.*;
...
public class ModDataComponentTypes {
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENT_TYPES =
            DeferredRegister.createDataComponents(Boulanger.MOD_ID);
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<IngredientItemComponent>> INGREDIENT_TYPE =
            register("ingredient_type", builder -> builder
                    .persistent(IngredientItemComponent.CODEC)
                    .networkSynchronized(IngredientItemComponent.STREAM_CODEC)
            );
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<WeightComponent>> INGREDIENT_MILLIGRAMS =
            register("ingredient_milligrams", builder -> builder
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<BakeryAdditiveComponent>> BAKERY_ADDITIVE =
            register("bakery_additive", builder -> builder
                    .persistent(BakeryAdditiveComponent.CODEC)
                    .networkSynchronized(BakeryAdditiveComponent.STREAM_CODEC)
            );
