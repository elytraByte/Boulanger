...
public record WheatVarietyRecord(ResourceLocation id) {
    public static final Codec<WheatVarietyRecord> CODEC = ResourceLocation.CODEC.xmap(WheatVarietyRecord::new, WheatVarietyRecord::id);
...
//    public static WheatVariety[] values() {
//    }
}
